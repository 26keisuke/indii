...
// export function updateImage(id, value, context) {
//     axios.post(`/api/profile/${id}/photo`, {photo: value})
//     .then(() => {
//         context.disableGray()
//         context.fetchProfile(id)
//         context.fetchUser();
...
// export function updateIntro(id, value, context) {
//     axios.post(`/api/profile/${id}/intro`, {intro: value})
//     .then(() => {
//         context.disableGray()
//         context.fetchProfile(id)
//         context.fetchUser();
