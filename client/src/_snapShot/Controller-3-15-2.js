...
function withSearch(WrappedComponent, type, theme, placeholder, postAction, storageId, topicId) {
    ...
    return class extends Component {
        ...
        getPostSuggestions = () => {
            this.props.searchFetching("ACTION", true)
            this.props.searchPost(type, value, topicId)  // topicIdがある場合はtopic内で検索される
        }
